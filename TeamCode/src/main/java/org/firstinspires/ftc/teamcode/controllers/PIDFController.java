 ...
 *
 * This is the FTCLib implementation, altered to use kF as a static term instead of a state-based feedforward.
 */
public class PIDFController {
    ...
    public double calculate(double pv) {
        ...
        // minor modifications from FTCLib's implementation to use kF the way it's more often used
        double output = kP * errorVal_p + kI * totalError + kD * errorVal_v;
